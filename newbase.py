#!/usr/bin/env python3
"""
Goldbach sampler with three racing strategies, optional quiet mode, and a --race flag.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Goldbach sampler with three racing strategies and optional race mode."
    )
    parser.add_argument(
        "--sweep",
        type=str,
...
def main() -> None:
    ...
    if args.race:
        ...
        # This ensures each strategy sees the same sequence of n.
